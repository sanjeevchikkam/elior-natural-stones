        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start" id="contact-content-grid">
          ...
          <div className="lg:col-span-5 space-y-10" id="contact-left-column">
            ...
            <div className="space-y-4">
              <span className="text-[9px] font-mono text-[#B9B1A5] uppercase tracking-[0.3em] block">
                Contact Us
              </span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-white/5" id="contact-trust-badges">
              <div className="p-4 rounded-sm bg-[#121212] border border-white/5 flex gap-3 items-start">
                <div className="p-2 bg-[#B9B1A5]/10 rounded border border-[#B9B1A5]/20 shrink-0">
                  <ShieldCheck className="w-4 h-4 text-[#B9B1A5]" />
                </div>
                <div>
              ...
              <div className="p-4 rounded-sm bg-[#121212] border border-white/5 flex gap-3 items-start">
                <div className="p-2 bg-[#B9B1A5]/10 rounded border border-[#B9B1A5]/20 shrink-0">
                  <Award className="w-4 h-4 text-[#B9B1A5]" />
                </div>
                <div>
            ...
            <div className="space-y-4 pt-4 border-t border-white/5" id="contact-direct-channels">
              <span className="text-[9px] font-mono text-[#B9B1A5] uppercase tracking-[0.3em] block mb-2">
                Direct Touchpoints
              </span>
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="w-10 h-10 rounded-sm bg-white/5 border border-white/10 group-hover:border-[#B9B1A5]/30 group-hover:bg-[#B9B1A5]/10 flex items-center justify-center text-[#B9B1A5] transition-all duration-300 shrink-0">
                    <Phone className="w-4 h-4" />
                  </div>
                  <div>
                    <h5 className="text-xs font-bold text-white group-hover:text-[#B9B1A5] transition-colors tracking-wide uppercase font-mono">Immediate Hotline</h5>
                ...
                >
                  ...
                  <div>
                    <h5 className="text-xs font-bold text-white group-hover:text-[#B9B1A5] transition-colors tracking-wide uppercase font-mono">Direct Procurement Email</h5>
          ...
          <div className="lg:col-span-7" id="contact-right-column">
            <div className="bg-[#121212] border border-white/5 hover:border-[#B9B1A5]/10 rounded-sm p-6 md:p-8 relative shadow-2xl transition-all duration-500" id="contact-form-card">
              
              {/* Header inside Form Card */}
              <div className="flex items-center gap-3 mb-8 pb-6 border-b border-white/5" id="form-card-header">
                <div className="p-2.5 bg-[#B9B1A5]/10 rounded-sm border border-[#B9B1A5]/25">
                  <Building2 className="w-5 h-5 text-[#B9B1A5]" />
                </div>
                <div>
                  <h3 className="text-lg font-serif font-bold text-white tracking-wide">
                    Enquiry
                  </h3>
                  <p className="text-[10px] font-mono text-[#B9B1A5] tracking-wider uppercase mt-1">
              ...
              <AnimatePresence mode="wait">
                {!isSubmitted ? (
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="flex flex-col gap-2" id="form-group-name">
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 bg-black/40 border border-white/10 focus:border-[#B9B1A5]/60 rounded-sm text-sm text-white placeholder-white/30 focus:outline-none transition-all duration-300 focus:bg-black/60 focus:shadow-[0_0_15px_rgba(212,175,55,0.1)]"
                        />
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="flex flex-col gap-2" id="form-group-category">
                        ...
                        <select
                          ...
                          className="w-full px-4 py-3 bg-black/40 border border-white/10 focus:border-[#B9B1A5]/60 rounded-sm text-sm text-white placeholder-white/30 focus:outline-none transition-all duration-300 focus:bg-[#121212] cursor-pointer appearance-none focus:shadow-[0_0_15px_rgba(212,175,55,0.1)]"
                        >
                          {CATEGORIES.map((cat) => (
                    ...
                    <div className="flex flex-col gap-2" id="form-group-message">
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-3 bg-black/40 border border-white/10 focus:border-[#B9B1A5]/60 rounded-sm text-sm text-white placeholder-white/30 focus:outline-none transition-all duration-300 focus:bg-black/60 focus:shadow-[0_0_15px_rgba(212,175,55,0.1)] resize-none"
                      />
                    </div>
                    ...
                    <div className="flex items-center gap-2.5 text-white/40 text-[10px] font-mono leading-relaxed bg-black/20 p-3 rounded-sm border border-white/[0.02]">
                      <Lock className="w-3.5 h-3.5 text-[#B9B1A5] shrink-0" />
                    ...
                    <button
                      type="submit"
                      className="w-full py-4 bg-[#B9B1A5] text-[#0B0B0B] hover:bg-[#B9B1A5] text-xs font-bold uppercase tracking-widest transition-all duration-300 rounded-sm shadow-[0_4px_20px_rgba(212,175,55,0.2)] hover:shadow-[0_4px_25px_rgba(212,175,55,0.35)] flex items-center justify-center gap-2.5 cursor-pointer active:scale-[0.99]"
                  ...
                  >
                    <div className="w-14 h-14 rounded-full bg-[#B9B1A5]/10 border border-[#B9B1A5]/35 flex items-center justify-center text-[#B9B1A5] mb-6 animate-bounce">
                    ...
                    <div className="flex items-center gap-2 text-[10px] font-mono text-[#B9B1A5] tracking-widest uppercase animate-pulse">
