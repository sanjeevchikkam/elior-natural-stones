...
export default function OurStoryPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0B0B] text-[#E5E5E5] selection:bg-[#B9B1A5]/30 selection:text-[#B9B1A5]" id="our-story-page-root">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden border-b border-white/5" id="story-hero-section">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center relative z-10 pt-20" id="story-hero-content-wrapper">
          ...
          >
            <span className="text-xs font-mono text-[#B9B1A5] tracking-[0.4em] uppercase" id="story-hero-tagline">
            ...
            <div className="w-24 h-[1px] bg-[#B9B1A5] mx-auto mb-6" />
        ...
        <div className="absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-[#B9B1A5]/30 to-transparent" />
      </section>
      ...
      <section className="py-24 bg-[#0B0B0B] relative z-10" id="story-timeline-section">
        <div className="max-w-6xl mx-auto px-6 md:px-12">
          ...
          <div className="text-center max-w-2xl mx-auto mb-20" id="timeline-header-wrapper">
            <span className="text-[10px] text-[#B9B1A5] font-mono tracking-[0.3em] uppercase">Chronology of Excellence</span>
          ...
          <div className="relative border-l border-white/10 md:border-l-0 md:after:content-[''] md:after:absolute md:after:top-0 md:after:bottom-0 md:after:left-1/2 md:after:-translate-x-1/2 md:after:w-[1px] md:after:bg-white/10" id="timeline-flow-container">
            {MILESTONES.map((milestone, index) => {
              ...
              return (
                ...
                >
                  {/* Circle Pinpoint */}
                  <div className="absolute left-[-25px] md:left-1/2 md:-translate-x-1/2 top-4 w-12 h-12 rounded-full bg-[#121212] border-2 border-[#B9B1A5] flex items-center justify-center z-30 shadow-lg shadow-black">
                    <span className="text-[10px] font-mono font-bold text-[#B9B1A5]">{index + 1}</span>
                  </div>
                  ...
                  <div className="w-full md:w-1/2 pl-8 md:pl-0 md:px-12">
                    <motion.div
                      ...
                      className="bg-[#121212] border border-white/10 hover:border-[#B9B1A5]/40 rounded-sm p-6 md:p-8 transition-all duration-300 shadow-xl relative"
                      id={`timeline-card-${index}`}
                    >
                      {/* Top border gold hover light */}
                      <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#B9B1A5] to-transparent scale-x-0 group-hover:scale-x-100 transition-transform duration-500" />
                      
                      <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
                        <span className="text-2xl font-serif font-bold text-[#B9B1A5] tracking-wider font-mono">
                          {milestone.year}
                        </span>
                      ...
                      <p className="text-xs font-mono text-[#B9B1A5]/80 uppercase tracking-widest mt-1 mb-4">
                        {milestone.subtitle}
                      </p>
                      ...
                      <div className="border-t border-white/5 pt-4">
                        <h4 className="text-[10px] font-mono text-[#B9B1A5] uppercase tracking-[0.2em] mb-3 font-semibold">Key Achievements</h4>
                        <ul className="space-y-2.5">
                          {milestone.achievements.map((ach, idx) => (
                            <li key={idx} className="flex items-start gap-2.5 text-xs text-[#E5E5E5]/80">
                              <span className="text-[#B9B1A5] font-serif mt-0.5">✦</span>
      ...
      <section className="py-24 bg-[#121212] border-t border-b border-white/5 relative overflow-hidden" id="story-trust-builder">
        ...
        <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-[#B9B1A5]/2 blur-[120px] rounded-full pointer-events-none" />

        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-20" id="trust-header-wrapper">
            <span className="text-[10px] text-[#B9B1A5] font-mono tracking-[0.4em] uppercase">Why Elite Architects Choose Us</span>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-white mt-3">The Elior Trust Builder</h2>
            <div className="w-16 h-[1px] bg-[#B9B1A5] mx-auto mt-6 mb-4" />
            ...
            {TRUST_FACTORS.map((factor, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-[#0B0B0B] border border-white/5 hover:border-[#B9B1A5]/30 p-6 rounded-sm transition-all duration-300 flex flex-col gap-4 shadow-lg group hover:-translate-y-1"
                  id={`trust-card-${idx}`}
                >
                  <div className="w-10 h-10 rounded-sm bg-[#B9B1A5]/5 border border-[#B9B1A5]/20 flex items-center justify-center text-[#B9B1A5] group-hover:bg-[#B9B1A5]/10 transition-colors duration-300">
                    <IconComp className="w-5 h-5" />
                  </div>
                  <h3 className="text-base font-serif font-bold text-white group-hover:text-[#B9B1A5] transition-colors duration-300">
                    {factor.title}
                  </h3>
          ...
          <div className="mt-20 bg-[#0B0B0B] border border-[#B9B1A5]/15 rounded-sm p-8 md:p-12 relative overflow-hidden" id="trust-stats-banner">
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#B9B1A5]/3 rounded-full blur-2xl pointer-events-none" />
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 text-center" id="stats-grid-wrapper">
              <div className="flex flex-col items-center">
                ...
                <span className="text-[10px] text-[#B9B1A5] font-mono uppercase tracking-widest mt-2">Years Legacy</span>
              </div>
              <div className="flex flex-col items-center border-l border-white/10">
                <span className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-white font-mono">12M+</span>
                <span className="text-[10px] text-[#B9B1A5] font-mono uppercase tracking-widest mt-2">Sq.Ft Supplied</span>
              </div>
              <div className="flex flex-col items-center border-l border-white/10">
                <span className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-white font-mono">100%</span>
                <span className="text-[10px] text-[#B9B1A5] font-mono uppercase tracking-widest mt-2">Direct Sourced</span>
              </div>
              <div className="flex flex-col items-center border-l border-white/10">
                <span className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-white font-mono">12%</span>
                <span className="text-[10px] text-[#B9B1A5] font-mono uppercase tracking-widest mt-2">Curation Rate</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-[#0B0B0B] text-center relative z-10" id="story-call-to-action">
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            <span className="text-[10px] font-mono text-[#B9B1A5] tracking-[0.3em] uppercase block mb-3">Authenticity Check</span>
