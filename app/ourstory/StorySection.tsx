...
export default function StorySection() {
  ...
  return (
    <section className="py-24 bg-[#121212] border-t border-b border-white/5 relative overflow-hidden" id="our-story">
      ...
      <div className="absolute top-1/2 right-0 -translate-y-1/2 w-96 h-96 bg-[#B9B1A5]/2 blur-[100px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5" id="story-section-teaser-info">
            <span className="text-[10px] md:text-xs text-[#B9B1A5] font-mono tracking-[0.4em] uppercase" id="story-section-pre-title">
              Our Heritage & Trust
            </span>
            ...
            <div className="w-16 h-[1px] bg-[#B9B1A5] mb-6" />
            ...
            <div className="space-y-4 mb-8" id="story-section-badges">
              <div className="flex items-start gap-3.5">
                <div className="w-8 h-8 rounded-sm bg-[#B9B1A5]/5 border border-[#B9B1A5]/20 flex items-center justify-center text-[#B9B1A5] shrink-0">
            ...
            <Link
              href="/ourstory"
              className="inline-flex items-center gap-2.5 px-6 py-3 bg-transparent border border-[#B9B1A5]/40 hover:border-[#B9B1A5] text-[#B9B1A5] text-xs font-mono tracking-widest uppercase transition-all duration-300 rounded-sm hover:bg-[#B9B1A5]/5"
          ...
          <div className="lg:col-span-7" id="story-section-timeline-preview">
            <div className="bg-[#0B0B0B] border border-white/5 rounded-sm p-6 md:p-8 relative" id="story-timeline-preview-card">
              <div className="absolute top-4 right-4 text-[10px] font-mono text-white/20 tracking-widest uppercase flex items-center gap-1.5">
                <Hourglass className="w-3.5 h-3.5 text-[#B9B1A5]/60" />
                Timeline
              </div>
              ...
              <div className="relative border-l border-white/10 pl-5 space-y-8" id="mini-timeline-track">
                {previewTimeline.map((item, index) => (
                  <div key={item.year} className="relative" id={`mini-timeline-node-${index}`}>
                    {/* Ring dot */}
                    <div className="absolute -left-[26px] top-1 w-3 h-3 rounded-full bg-[#121212] border-2 border-[#B9B1A5] z-10" />
                    
                    <div className="flex flex-col md:flex-row md:items-baseline justify-between gap-1">
                      <span className="text-xs font-mono font-bold text-[#B9B1A5] uppercase tracking-wider">
                        {item.year}
                      </span>
              ...
              <div className="mt-8 border-t border-white/5 pt-5 flex items-center justify-between" id="timeline-preview-footer">
                <div className="flex flex-col">
                  <span className="text-[10px] font-mono text-[#B9B1A5]/80 uppercase tracking-widest font-semibold">Elior Natural Stones</span>
